...
- Применены миграции до `20260612_0003`.
...
3. Следующий продуктовый шаг: делать действия центра в карточке:
   - вернуть на доработку;
   - принять;
   - отправить на диагностику;
   - направить на списание;
   - направить на оценку / продажу.
4. После действий центра - подключить audit log к изменениям статусов.
5. При реализации редактирования и действий центра использовать `row_version`: если карточку изменили параллельно, не перетирать свежие данные.
6. Отдельный UX-шаг: показывать в форме только поля выбранного типа оборудования, а не все fieldset сразу.
