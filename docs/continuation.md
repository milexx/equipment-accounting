...
3. Следующий продуктовый шаг: сделать управление пользователями/учётками для `center_admin` или, если администрирование отложить, сделать динамический показ полей формы по выбранному типу.
